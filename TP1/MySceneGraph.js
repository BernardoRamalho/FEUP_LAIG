...
class MySceneGraph {
    ...
    createAnimation(animationInformation, animationID){
        var animation = new MyKeyframeAnimation(animationID);
    ...
    createKeyframe(keyframeInformation){
        ...
        var keyframe = new MyKeyframe(instant * 1000);
    ...
    createCylinder(cylinderInfo){
        ...
        if(height === null){
            this.onXMLMinorError("Couldn't get the height value of cylinder. Returning null");
            return null;
        }

        let topRadius = this.reader.getFloat(cylinderInfo, "topRadius");
        if(topRadius === null){
            this.onXMLMinorError("Couldn't get the topRadius value of cylinder. Returning null");
            return null;
        }

        let bottomRadius = this.reader.getFloat(cylinderInfo, "bottomRadius");
        if(bottomRadius === null){
            this.onXMLMinorError("Couldn't get the bottomRadius value of cylinder. Returning null");
            return null;
        }

        let stacks = this.reader.getFloat(cylinderInfo, "stacks");
        if(stacks === null){
            this.onXMLMinorError("Couldn't get the stacks value of cylinder. Returning null");
            return null;
        }

        let slices = this.reader.getFloat(cylinderInfo, "slices");
        if(slices === null){
            this.onXMLMinorError("Couldn't get the slices value of cylinder. Returning null");
            return null;
        }
    ...
    createSphere(sphereInfo){
        ...
        if(radius === null){
            this.onXMLMinorError("Couldn't get the radius value of sphere. Returning null");
            return null;
        }

        let stacks = this.reader.getFloat(sphereInfo, "stacks");
        if(stacks === null){
            this.onXMLMinorError("Couldn't get the stacks value of sphere. Returning null");
            return null;
        }
    ...
    createTorus(torusInfo){
        ...
        if(inner === null){
            this.onXMLMinorError("Couldn't get the inner value of torus. Returning null");
            return null;
        }

        let outer = this.reader.getFloat(torusInfo, "outer");
        if(outer === null){
            this.onXMLMinorError("Couldn't get the outer value of torus. Returning null");
            return null;
        }

        let loops = this.reader.getFloat(torusInfo, "loops");
        if(loops === null){
            this.onXMLMinorError("Couldn't get the loops value of torus. Returning null");
            return null;
        }

        let slices = this.reader.getFloat(torusInfo, "slices");
        if(slices === null){
            this.onXMLMinorError("Couldn't get the slices value of torus. Returning null");
            return null;
        }
    ...
    createRectangle(rectangleInfo, amplification){
        ...
        if(x1 === null){
            this.onXMLMinorError("Couldn't get the x1 value of rectangle. Returning null");
            return null;
        }

        let y1 = this.reader.getFloat(rectangleInfo, "y1");
        if(y1 === null){
            this.onXMLMinorError("Couldn't get the y1 value of rectangle. Returning null");
            return null;
        }

        let x2 = this.reader.getFloat(rectangleInfo, "x2");
        if(x2 === null){
            this.onXMLMinorError("Couldn't get the x2 value of rectangle. Returning null");
            return null;
        }

        let y2 = this.reader.getFloat(rectangleInfo, "y2");
        if(y2 === null){
            this.onXMLMinorError("Couldn't get the y2 value of rectangle. Returning null");
            return null;
        }
     ...
     * @param {Information of the Rectangle to be created} triangleInfo 
     */
    createTriangle(triangleInfo, amplification){
        // Get Triangle Attributes
        let x1 = this.reader.getFloat(triangleInfo, "x1");
        if(x1 === null){
            this.onXMLMinorError("Couldn't get the x1 value of triangle. Returning null");
            return null;
        }

        let y1 = this.reader.getFloat(triangleInfo, "y1");
        if(y1 === null){
            this.onXMLMinorError("Couldn't get the y1 value of triangle. Returning null");
            return null;
        }

        let x2 = this.reader.getFloat(triangleInfo, "x2");
        if(x2 === null){
            this.onXMLMinorError("Couldn't get the x2 value of triangle. Returning null");
            return null;
        }

        let y2 = this.reader.getFloat(triangleInfo, "y2");
        if(y2 === null){
            this.onXMLMinorError("Couldn't get the y2 value of triangle. Returning null");
            return null;
        }

        let x3 = this.reader.getFloat(triangleInfo, "x3");
        if(x3 === null){
            this.onXMLMinorError("Couldn't get the x3 value of triangle. Returning null");
            return null;
        }

        let y3 = this.reader.getFloat(triangleInfo, "y3");
        if(y3 === null){
            this.onXMLMinorError("Couldn't get the y3 value of triangle. Returning null");
            return null;
        }
